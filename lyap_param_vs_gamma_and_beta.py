...
if __name__ == "__main__":
    ...
    for mu, K in itertools.product(args.mu_list, args.K_list):
        ...
        for j, (params, label) in enumerate(zip([a_vs_gamma, b_vs_gamma, c_vs_gamma, d_vs_gamma], ["a", "b", "c", "d"])):
            ax = axs[j,0]
        ...
        for j, (params, label) in enumerate(zip([a_vs_beta, b_vs_beta, c_vs_beta, d_vs_beta], ["a", "b", "c", "d"])):
            ax = axs[j,1]
